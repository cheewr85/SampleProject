## 로또 번호 추첨기
- 로또 추첨기처럼 자동 생성을 해서 6개의 숫자를 랜덤으로 뽑음

- 혹은 번호를 직접 선택해서 추가할 수 있음

- 여기서 when 분기문을 사용해서 해당하는 각각 범위에 따라 뽑은 숫자를 보여주는 형태를 각각 배경을 다르게 함

- drawable을 직접 로또번호 공처럼 만듬

## 메인화면

### 실행화면
![one](/Basic/LottoPick/img/one.png)
...
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <Button
        ...
        android:text="@string/addButton_content"
    ...
    <Button
        ...
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
        android:text="@string/clearButton_content"
        app:layout_constraintEnd_toEndOf="parent"
    ...
    <LinearLayout
        ...
        <TextView
            ...
            tools:visibility="visible"/><!--선택했을 때만 보여주기 위해서 gone tool로 xml 상에서 확인-->
    ...
    <Button
        ...
        android:text="@string/runButton_content"
...
### 로또 번호 배경 구현
- drawable 파일에 직접 추가, 동일한 형태이고 색깔만 다름
...
### 구현 코드
- 로또 번호가 1~45임을 감안, 숫자를 랜덤하게 생성하는 것보다 1~45의 숫자를 수동으로 추가하고 List에 담아서 초기화하고 그 List를 랜덤하게 섞음, 그 중에서 선택함

- 숫자를 나타낼 TextView를 리스트로 담아서 활용함 인자로 TextView를 씀, 뽑은 숫자와 수동으로 추가한 숫자를 감안해서 함수로 처리함

- 실제 나타나는 숫자는 Set형태로 별도로 저장함, 각각 수동으로 추가하는 경우와 자동으로 생성할 때 별도로 작용함 이벤트가 그래서 중복 처리 방지하고 6개에 맞게 수동, 자동 작업을 동시에 진행할 수 있음
